...
//            }
    ...
    init {
        try {
            ...
            register(LangCss::class.java)
            register(LangDart::class.java)
            register(LangErlang::class.java)
            register(LangGo::class.java)
            register(LangHs::class.java)
            register(LangLisp::class.java)
            register(LangLlvm::class.java)
            register(LangLua::class.java)
            register(LangMatlab::class.java)
            register(LangMd::class.java)
            register(LangMl::class.java)
            register(LangMumps::class.java)
            register(LangN::class.java)
            register(LangPascal::class.java)
            register(LangR::class.java)
            register(LangRd::class.java)
            register(LangScala::class.java)
            register(LangSql::class.java)
            register(LangTex::class.java)
            register(LangVb::class.java)
            register(LangVhdl::class.java)
            register(LangTcl::class.java)
            register(LangWiki::class.java)
            register(LangXq::class.java)
            register(LangYaml::class.java)
        } catch (ex: Exception) {
            LOG.log(Level.SEVERE, null, ex)
        }
    }
