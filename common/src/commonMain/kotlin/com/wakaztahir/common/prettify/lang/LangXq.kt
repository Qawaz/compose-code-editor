...
class LangXq : Lang() {
    companion object {
        ...
        val fileExtensions: List<String>
            get() = Arrays.asList(*arrayOf("xq", "xquery"))
    }
    ...
    init {
        ...
        // Matching @Attributes
        _fallthroughStylePatterns.add(Arrays.asList(*arrayOf<Any>(Prettify.PR_LITERAL, Pattern.compile("^\\@[\\w-]+"))))
        // Matching xml tags
        _fallthroughStylePatterns.add(
            Arrays.asList(
                *arrayOf<Any>(
