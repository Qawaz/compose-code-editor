...
class LangWiki : Lang() {
    protected class LangWikiMeta : Lang() {
        companion object {
            val fileExtensions: List<String>
                get() = Arrays.asList(*arrayOf("wiki.meta"))
        }
    ...
    companion object {
        val fileExtensions: List<String>
            get() = Arrays.asList(*arrayOf("wiki"))
    }
    ...
    init {
        ...
        _fallthroughStylePatterns.add(Arrays.asList(*arrayOf<Any>("lang-", Pattern.compile("^`([^\r\n`]+)`"))))
        // An inline URL.
        _fallthroughStylePatterns.add(
            Arrays.asList(
                *arrayOf<Any>(
        ...
        setShortcutStylePatterns(_shortcutStylePatterns)
        setFallthroughStylePatterns(_fallthroughStylePatterns)
        setExtendedLangs(Arrays.asList(*arrayOf<Lang>(LangWikiMeta())))
    }
}